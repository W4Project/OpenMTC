...
if __name__ == '__main__':
    ...
    host = 'mqtts://upCARE1:updilimanCARE1@5e2b4a7e93854896a48c9e7e2ae92ae9.s1.eu.hivemq.cloud:8883#in-cse-1'
    app = TestGUI(
        poas=['mqtts://upCARE1:updilimanCARE1@5e2b4a7e93854896a48c9e7e2ae92ae9.s1.eu.hivemq.cloud:8883'],          # adds poas in order to receive notifications
        # SSL options
